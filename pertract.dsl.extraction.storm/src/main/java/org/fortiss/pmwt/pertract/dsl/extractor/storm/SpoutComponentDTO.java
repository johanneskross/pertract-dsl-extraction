...
@JsonIgnoreProperties(value={"executorStats", "outputStats"})
public class SpoutComponentDTO {
	...
	private SpoutSummaryDTO[] spoutSummary;
	
	public SpoutComponentDTO() {
	}
	...
	public SpoutSummaryDTO[] getSpoutSummary() {
		return spoutSummary;
	}

	public void setSpoutSummary(SpoutSummaryDTO[] spoutSummary) {
		this.spoutSummary = spoutSummary;
	}
}
